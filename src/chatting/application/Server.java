...
public class Server extends JFrame implements ActionListener{
    ...
    Server(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons-20230325T112926Z-001/icons/1.png"));
        ...
        JLabel name =new JLabel("Shekhar");
    ...
    public static void main(String[] args){
        ...
        try{
           ServerSocket skt = new ServerSocket(6001);//6001 is a port number
           while(true){
               Socket s = skt.accept();
           ...
           }//server works infinitely and accepts all messages
